...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang="en" className="h-full bg-slate-950 text-slate-100">
      <head>
        <title>Aequitas AI - Premium Equity Intelligence</title>
        <meta name="description" content="Instant institutional-grade stock and equity analysis powered by LangGraph & Gemini." />
